...
const Footer = () => {
  return (
    <div className="rounded-3xl">
      <div className="bg-richblack-800 rounded-3xl">
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-center justify-between w-11/12 max-w-maxContent text-richblack-400 leading-6 mx-auto relative py-8 lg:py-14">
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
          ...
          <div className="w-full lg:w-[50%] flex flex-wrap flex-col sm:flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            <div className="w-full sm:w-[48%] lg:w-[30%] flex flex-col gap-3 mb-7 lg:pl-0">
              <img src={LearningEdgeLogo} alt="LearningEdge Logo" className="object-contain w-32 sm:w-40" />
      ...
      {/* Bottom footer */}
      <div className="flex flex-col items-center justify-center w-11/12 max-w-maxContent text-richblack-400 mx-auto pb-8 lg:pb-14 text-sm">
        <div className="flex flex-col items-center gap-6 w-full">
          ...
          <div className="flex flex-wrap justify-center gap-2 lg:gap-3">
            {BottomFooter.map((ele, ind) => (
              <div
                key={ind}
                className={`${BottomFooter.length - 1 === ind ? "" : "border-r border-richblack-700"} px-3 cursor-pointer hover:text-richblack-50 transition-all duration-200`}
              >
                <Link to="/">
                  {ele}
                </Link>
