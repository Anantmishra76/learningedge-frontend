    ...
    return (
        <div className="fixed inset-0 z-[1000] !mt-0 grid place-items-center overflow-auto bg-white bg-opacity-10 backdrop-blur-sm">
            <div className="w-10/12 max-w-[350px] rounded-lg border border-richblack-400 bg-richblack-800 p-6">
                ...
                <p className="mt-3 mb-5 leading-6 text-slate-600">
                    {modalData?.text2}
                </p>
                ...
                <div className="flex items-center gap-x-4">
                    ...
                    />
                    <button
                        className="cursor-pointer rounded-md bg-richblack-200 text-slate-900 hover:bg-richblack-900 hover:text-slate-600
