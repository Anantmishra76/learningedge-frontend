  ...
  return (
    <div className="space-y-4">
      {[...Array(4)].map((_, i) => (
        <div
          key={i}
          className="flex items-center gap-4 p-4 bg-richblack-700/30 rounded-lg border border-richblack-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full rounded-lg bg-richblack-700 p-3 text-slate-900 border border-richblack-600"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full rounded-lg bg-richblack-700 p-3 text-slate-900 "
              />
            </div>
          </div>
          <IconBtn
            ...
            customClasses="bg-brand-600 "></IconBtn>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-richblack-800 to-richblack-900 rounded-xl border border-richblack-700 p-8 shadow-lg hover:shadow-xl transition-all duration-300">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-slate-600 text-sm">
              {subLinks?.length || 0} categories - Manage your course
              organization
            </p>
          </div>
        </div>
