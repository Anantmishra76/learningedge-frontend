  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 sm:space-y-8">
      ...
      <div className="text-center sm:text-left">
        <h1 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-2">My Profile</h1>
        <p className="text-slate-600">Manage and view your account information</p>
      </div>
      ...
      <div className="relative bg-gradient-to-br from-richblack-800 to-richblack-900 rounded-2xl border border-richblack-700 p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
        ...
        <div className="relative flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="flex-1 text-center sm:text-left">
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-2 capitalize">
              {user?.firstName + " " + user?.lastName}
            </h2>
            <p className="text-base sm:text-lg text-slate-600 mb-4">{user?.email}</p>

            <div className="flex flex-wrap justify-center sm:justify-start gap-2 sm:gap-4 text-xs sm:text-sm">
              <span className="px-3 py-1 bg-richblack-700 rounded-full text-slate-600 capitalize">
                {user?.accountType}
              </span>
              <span className="px-3 py-1 bg-richblack-700 text-slate-600 rounded-full font-medium capitalize">
                Active Member
              </span>
              <span className="px-3 py-1 bg-richblack-700 text-slate-600 rounded-full font-medium flex items-center gap-1 capitalize">
      ...
      <div className="bg-gradient-to-br from-richblack-800 to-richblack-900 rounded-xl border border-richblack-700 p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300">
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg sm:text-xl font-semibold text-slate-900">About</h3>
              <p className="text-slate-600 text-xs sm:text-sm">Tell us about yourself</p>
            </div>
          </div>
          <IconBtn
            text="Edit"
            onclick={() => navigate("/dashboard/settings")}
            customClasses="bg-richblack-700 text-slate-900 hover:bg-richblack-600"
          >
            <RiEditBoxLine />
          </IconBtn>
        </div>
      ...
      <div className="bg-gradient-to-br from-richblack-800 to-richblack-900 rounded-xl border border-richblack-700 p-6 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300">
        <div className="flex items-center justify-between mb-6 sm:mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg sm:text-xl font-semibold text-slate-900">Personal Details</h3>
              <p className="text-slate-600 text-xs sm:text-sm">Your personal information</p>
            </div>
          </div>
          <IconBtn
            text="Edit"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-richblack-700/30 rounded-lg border border-richblack-600 hover:bg-richblack-700/50 transition-colors">
              ...
              <div>
                <p className="text-xs sm:text-sm text-slate-500 mb-1">First Name</p>
                <p className="text-slate-900 font-medium capitalize">{user?.firstName}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-richblack-700/30 rounded-lg border border-richblack-600 hover:bg-richblack-700/50 transition-colors">
              ...
              <div>
                <p className="text-xs sm:text-sm text-slate-500 mb-1">Account Type</p>
                <p className="text-slate-900 font-medium capitalize">{user?.accountType}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-richblack-700/30 rounded-lg border border-richblack-600 hover:bg-richblack-700/50 transition-colors">
              <AiOutlineUser className="text-blue-400 text-lg sm:text-xl flex-shrink-0" />
              <div>
                <p className="text-xs sm:text-sm text-slate-500 mb-1">Gender</p>
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-richblack-700/30 rounded-lg border border-richblack-600 hover:bg-richblack-700/50 transition-colors">
              <AiOutlineUser className="text-blue-400 text-lg sm:text-xl flex-shrink-0" />
              <div>
                <p className="text-xs sm:text-sm text-slate-500 mb-1">Last Name</p>
                <p className="text-slate-900 font-medium capitalize">{user?.lastName}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-richblack-700/30 rounded-lg border border-richblack-600 hover:bg-richblack-700/50 transition-colors">
              ...
              <div>
                <p className="text-xs sm:text-sm text-slate-500 mb-1">Phone Number</p>
                <p className="text-slate-900 font-medium">
            ...
            <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-richblack-700/30 rounded-lg border border-richblack-600 hover:bg-richblack-700/50 transition-colors">
              ...
              <div>
                <p className="text-xs sm:text-sm text-slate-500 mb-1">Date of Birth</p>
                <p className="text-slate-900 font-medium">
