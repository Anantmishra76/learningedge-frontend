...
import { getUserEnrolledCourses } from "@/features/dashboard/services/profileAPI"
        ...
        <div className="my-8 text-slate-900">
          ...
          {/* Course Names */}
          {
            enrolledCourses?.map((course, i, arr) => (
              <div
                className={`flex flex-col sm:flex-row sm:items-center border border-richblack-700 hover:bg-richblack-700 transition-colors duration-200 ${i === arr.length - 1 ? "rounded-b-2xl" : "rounded-none"}`}
                key={i}
              >
                <div
                ...
                >
                  <Img
                    ...
                    alt="course_img"
                    className="h-14 w-14 rounded-lg object-cover hover:scale-105 transition-transform duration-200"
                  />
