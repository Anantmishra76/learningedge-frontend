...
// API functions
import { getPasswordResetToken } from "@/features/auth/services/authAPI"
    ...
    <div className="grid min-h-[calc(100vh-3.5rem)] place-items-center">
      {loading ? (
        ...
        <div className="max-w-[500px] p-4 lg:p-8 bg-richblack-800 rounded-lg shadow-lg">
          ...
          <div className="my-4 text-[1.125rem] leading-[1.625rem] text-slate-700">
            {!emailSent
          ...
          <form onSubmit={!emailSent ? handleOnSubmit : handleResetSubmit} className="space-y-4">
            {!emailSent ? (
              <label className="w-full">  
                ...
                <input
                  ...
                  className="w-full rounded-[0.5rem] bg-richblack-800 p-[12px] text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </label>
            ) : (
              <>
                ...
                <label className="relative w-full">
                  ...
                  <input
                    ...
                    className="w-full rounded-[0.5rem] bg-richblack-800 p-[12px] pr-10 text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <span
            ...
            <button
              type="submit"
              className="mt-6 w-full rounded-[8px] bg-blue-50 hover:bg-blue-100 transition-colors duration-200 py-[12px] px-[12px] font-medium text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-600 text-center"
            >
